...
def estimate_pose(cam_or_vid: str):
    ...
    while True:
        ...
        # This stuff draws the neck line from the hips (because that looks better and wouter think that a neck begins at the hips) to the nose
        start = (
        ...
        pixelBlackBg = cv.resize(
            pixelBlackBg, (1920, 1080), interpolation=cv.INTER_NEAREST
        )
